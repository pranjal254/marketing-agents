...
def flagship_user_prompt(
    ...
    return (
        ...
        "talking, never like a product brochure or a spec sheet.\n"
        ...
        "- A claim you cannot source goes in gap_notes, never in the prose. Unsourced "
        "sections should still be written as insight and narrative; only the specific "
        "unverifiable number or name is what belongs in a gap note.\n"
        + feedback
